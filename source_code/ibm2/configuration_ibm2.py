...
class IBM2Config(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a [`IBM2Model`]. It is used to instantiate a IBM2
    model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
    defaults will yield a similar configuration to that of the IBM2
    [state-spaces/IBM2-2.8b](https://huggingface.co/state-spaces/IBM2-2.8b) architecture.
    ...
    Args:
        ...
        vocab_size (`int`, *optional*, defaults to 32768):
            Vocabulary size of the IBM2 model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`IBM2Model`].
